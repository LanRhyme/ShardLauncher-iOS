...
void init_logDeviceAndVer(char *argument) {
    // ShardLauncher version
    NSLog(@"[Pre-Init] ShardLauncher INIT!");
...
int main(int argc, char *argv[]) {
    ...
    // If sandbox is disabled, W^X JIT can be enabled by ShardLauncher itself
